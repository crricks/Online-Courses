...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        xVal, yVal = math.floor(pos.getX()), math.floor(pos.getY())
        if [xVal, yVal] not in self.cleanTiles: 
            self.cleanTiles.append([xVal, yVal])
    ...
    def getRandomPosition(self):
        ...
        """
        xVal, yVal = random.uniform(0, self.width), random.uniform(0, self.height)
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        if math.floor(pos.getX()) in range(0, self.width) and math.floor(pos.getY()) in range(0, self.height):
            return True
        return False
